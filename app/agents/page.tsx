...
export default async function AgentsPage() {
  ...
  return <>
    ...
    <section className="agent-catalog-section builtin-agent-section" aria-labelledby="builtin-agent-heading">
      <div className="agent-catalog-heading"><div><p className="eyebrow">SYSTEM BUILT-IN</p><h2 id="builtin-agent-heading">内置 Agent</h2></div><p className="muted">系统恢复、验证、学习与交互使用的内部模型角色。权限和 Prompt 属于 Harness 安全协议，不开放编辑。</p></div>
