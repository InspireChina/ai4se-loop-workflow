...
export default async function AgentsPage() {
  ...
  return <>
    <header><p className="eyebrow">AGENT CONFIGURATION</p><h1>Agent 配置</h1><p className="muted">命令链、Prompt 与 Runtime 是 LoopWork 全局配置，不随项目切换；Memory 和演化证据仍由当前项目独立保存。</p></header>
