...
export const REQUIREMENT_CONTEXT_WORKFLOW: Record<RequirementContextPhase, RequirementContextWorkPacketDefinition> = {
  ...
  acceptance: {
    objective: '根据最终 TO-BE 与 SCOPE 形成需求级验收语义。',
    required: '可观察 Acceptance；既定 Bug Fix Pipeline 必须有可靠 Existing Expected。',
    ...
    reviewBeforeSubmit: [
      ...
      '若既定 Pipeline 为 Bug Fix，可靠 Existing Expected 已存在。',
    ],
